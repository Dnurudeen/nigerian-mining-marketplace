...
@section('content')
    <div class="content">
        <section class="section about-section">
            <div class="container">
                <div>
                    <h1>Privacy policy for Nigerian Mining Marketplace</h1>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            refers to Nigerian Mining, Lagos, Nigeria.
                        </li>
                        <li>
                        ...
                        <li>
                            <b>Website</b> refers to nigerian mining marketplace, accessible from
                            <a href="https://marketplace.nigerianmining.com/">https://marketplace.nigerianmining.com/</a>
                        </li>
                        <li>
                    ...
                    <p>
                        ...
                        You close Your web browser. You can learn more about cookies on <a
                            href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies">TermsFeed website</a> article.
                    </p>
                    <p>
                    ...
                    <ul>
                        <li>
                            <b>Necessary / Essential Cookies </b>Type: Session Cookies Administered by: Us Purpose:
                        ...
                        <li>
                            <b>Cookies Policy / Notice Acceptance Cookies</b> Type: Persistent Cookies Administered
                            by: Us Purpose: These Cookies identify if users have accepted the use of cookies on the
                            Website.
                        </li>
                        <li>
                            <b>Functionality Cookies</b> Type: Persistent Cookies Administered by: Us Purpose: These
                    ...
                    <ul>
                        <li>
                            By email: <a
                                href="mailto:info@marketplace.nigerianmining.com">info@marketplace.nigerianmining.com</a>
                        </li>
                    </ul>
                </div>
            </div>
